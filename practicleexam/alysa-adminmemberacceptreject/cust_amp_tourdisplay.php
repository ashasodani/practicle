                            ...
                            <div class="card-body">
                              ...
                              <table id="example23" class="display nowrap table table-hover table-striped table-bordered dataTable">
                                        ...
                                        <tr style="background-color:#dedbdb;" >
                                             <td><a href="cust_amp_tourmanagement.php?id=<?php echo $row['id'];?>">Detail</a></td>
                                           <td><a href="cust_amp_tourmanagement_delete.php?id=<?php echo $row['id'];?>">Delete</a></td>
